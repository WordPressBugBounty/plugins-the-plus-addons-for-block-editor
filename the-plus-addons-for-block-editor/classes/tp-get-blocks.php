...
class Tpgb_Get_Blocks {
	...
	public function plus_blocks_options( $options = '', $blockname = '' ) {
		...
		// Svg Icon Load.
		if ( ( 'tpgb/tp-flipbox' === $blockname && ! empty( $options ) && ! empty( $options['layoutType'] ) && 'carousel' === $options['layoutType'] ) || ( 'tpgb/tp-infobox' === $blockname && ! empty( $options ) && ! empty( $options['layoutType'] ) && 'carousel' === $options['layoutType'] ) || ( 'tpgb/tp-flipbox' === $blockname && ! empty( $options ) && ! empty( $options['iconType'] ) && 'svg' === $options['iconType'] ) || ( 'tpgb/tp-infobox' === $blockname && ! empty( $options ) && ! empty( $options['iconType'] ) && 'svg' === $options['iconType'] ) || ( 'tpgb/tp-number-counter' === $blockname && ! empty( $options ) && ! empty( $options['iconType'] ) && 'svg' === $options['iconType'] ) || ( 'tpgb/tp-pricing-table' === $blockname && ! empty( $options ) && ! empty( $options['iconType'] ) && 'svg' === $options['iconType'] ) || ( 'tpgb/tp-button' === $blockname && ! empty( $options ) && ! empty( $options['svgIcon'] ) && ! empty( $options['svgIcon']['url'] ) ) || ( 'tpgb/tp-form-submit-button' === $blockname && ! empty( $options ) && ! empty( $options['ButtonType'] ) && 'svg' === $options['ButtonType'] ) || ( 'tpgb/tp-form-submit-button' === $blockname && ! empty( $options ) && ! empty( $options['ButtonType'] ) && 'svg' === $options['ButtonType'] ) || ( 'tpgb/tp-input-filter' === $blockname && ! empty( $options ) && ! empty( $options['headingIcon'] ) && 'svg' === $options['headingIcon'] ) || ( 'tpgb/tp-alphabet-filter' === $blockname && ! empty( $options ) && ! empty( $options['headingIcon'] ) && 'svg' === $options['headingIcon'] ) || ( 'tpgb/tp-button-filter' === $blockname && ! empty( $options ) && ! empty( $options['headingIcon'] ) && 'svg' === $options['headingIcon'] ) || ( 'tpgb/tp-checkbox-filter' === $blockname && ! empty( $options ) && ! empty( $options['headingIcon'] ) && 'svg' === $options['headingIcon'] ) || ( 'tpgb/tp-color-filter' === $blockname && ! empty( $options ) && ! empty( $options['headingIcon'] ) && 'svg' === $options['headingIcon'] ) || ( 'tpgb/tp-dropdown-filter' === $blockname && ! empty( $options ) && ! empty( $options['headingIcon'] ) && 'svg' === $options['headingIcon'] ) || ( 'tpgb/tp-image-filter' === $blockname && ! empty( $options ) && ! empty( $options['headingIcon'] ) && 'svg' === $options['headingIcon'] ) || ( 'tpgb/tp-radio-filter' === $blockname && ! empty( $options ) && ! empty( $options['headingIcon'] ) && 'svg' === $options['headingIcon'] ) || ( 'tpgb/tp-range-filter' === $blockname && ! empty( $options ) && ! empty( $options['headingIcon'] ) && 'svg' === $options['headingIcon'] ) || ( 'tpgb/tp-tabbing-filter' === $blockname && ! empty( $options ) && ! empty( $options['headingIcon'] ) && 'svg' === $options['headingIcon'] ) || ( 'tpgb/tp-rating-filter' === $blockname && ! empty( $options ) && ! empty( $options['headingIcon'] ) && 'svg' === $options['headingIcon'] ) || ( 'tpgb/tp-date-filter' === $blockname && ! empty( $options ) && ! empty( $options['headingIcon'] ) && 'svg' === $options['headingIcon'] ) ) {
