...
class Tpgb_Gutenberg_Settings_Options {
	...
	public function block_listout() {
		$this->block_lists = array(
			...
			'tp-search-filter'           => array(
				'label'      => esc_html__( 'Search Filter', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/shop-page-demo/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => '',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'Creative', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'search', 'filter', 'wp filter', 'wp' ),
			),
			'tp-single-product-pricing'  => array(
				'label'      => esc_html__( 'Single Product Pricing', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/product/air-jordan-1-high-og/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-product-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'product price', ' regular price', 'sale price' ),
			),
			'tp-single-product-meta'     => array(
				'label'      => esc_html__( 'Single Product Meta', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/product/air-jordan-1-high-og/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-product-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'product attribute', 'product meta', ' product category', 'product tag' ),
			),
			'tp-single-product-stock'    => array(
				'label'      => esc_html__( 'Single Product Stock', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/product/air-jordan-12-cream-gs/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-product-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'product stock', 'inventory status', 'stock status' ),
			),
			'tp-single-product-image'    => array(
				'label'      => esc_html__( 'Single Product Image', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/product/air-jordan-12-cream-gs/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-product-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'product image', 'product image gallery', ' woocommerce image', 'product photo gallery', 'product photo' ),
			),
			'tp-single-product-rating'   => array(
				'label'      => esc_html__( 'Single Product Rating', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/product/air-jordan-1-high-og/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-product-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'product rating', 'star rating', 'customer rating', 'rating badge' ),
			),
			'tp-product-add-to-cart'     => array(
				'label'      => esc_html__( 'Product Add to Cart', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/product/air-jordan-1-high-og/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-product-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'add to cart', 'add to cart button', ' buy now button', 'add to basket', 'add item to cart', ' add product' ),
			),
			'tp-single-product-review'   => array(
				'label'      => esc_html__( 'Single Product Review', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/product/air-jordan-1-high-og/#product-reviews?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-product-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'single product review', 'product review' ),
			),
			'tp-single-product-tab'      => array(
				'label'      => esc_html__( 'Single Product tab', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/product/air-slide-1/#product-tabs?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-product-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'product tabs', 'description tab', 'reviews tab', 'additional information tab', 'single product tabs', ' product information tabs', ' woocommerce tabs' ),
			),
			'tp-cart-table'              => array(
				'label'      => esc_html__( 'Cart Table', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/cart-page-demo/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-cart-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'cart table', 'shopping cart table', 'cart items list', 'cart summary table' ),
			),
			'tp-cart-total'              => array(
				'label'      => esc_html__( 'Cart Total', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/cart-page-demo/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-cart-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'cart total', 'cart subtotal', 'order total' ),
			),
			'tp-checkout-login'          => array(
				'label'      => esc_html__( 'Checkout Login', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/checkout-page-demo/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-checkout-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'checkout login form', 'login at checkout', 'returning customer login' ),
			),
			'tp-billing-address'         => array(
				'label'      => esc_html__( 'Billing Address', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/checkout-page-demo/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-checkout-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'billing address', ' billing address form', 'billing info' ),
			),
			'tp-shipping-address'        => array(
				'label'      => esc_html__( 'Shipping Address', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/checkout-page-demo/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-checkout-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'shipping address', 'delivery address', 'shipping address form', 'shipping info' ),
			),
			'tp-additional-information'  => array(
				'label'      => esc_html__( 'Additional Information', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/checkout-page-demo/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-checkout-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'additional information field', 'order notes field, checkout extra notes', 'special instructions field' ),
			),
			'tp-apply-coupon'            => array(
				'label'      => esc_html__( 'Apply Coupon', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/checkout-page-demo/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-checkout-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'apply coupon', 'coupon code field', 'enter discount code', 'coupon discount apply', 'coupon code input' ),
			),
			'tp-payment-method'          => array(
				'label'      => esc_html__( 'Payment Method', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/checkout-page-demo/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-checkout-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'payment method', 'payment options', 'select payment option', 'checkout payment choice' ),
			),
			'tp-order-review'            => array(
				'label'      => esc_html__( 'Order Review', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/checkout-page-demo/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-checkout-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'order review', 'order summary', 'order details', 'checkout order overview', 'purchase summary' ),
			),
			'tp-thank-you-address'       => array(
				'label'      => esc_html__( 'Thank You Address', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/thank-you-page-demo/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-thank-you-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'address details', 'shipping details', 'billing details', 'shipping summary', 'billing summary' ),
			),
			'tp-order-confirmation'      => array(
				'label'      => esc_html__( 'Order Confirmation', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/thank-you-page-demo/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-thank-you-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'order confirmation', 'purchase summary', ' order details' ),
			),
			'tp-order-payment'           => array(
				'label'      => esc_html__( 'Order Payment', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/thank-you-page-demo/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-thank-you-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'order payment', 'payment confirmation' ),
			),
			'tp-thank-you-order-details' => array(
				'label'      => esc_html__( 'Thank You Order Details', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/thank-you-page-demo/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/build-a-woocommerce-thank-you-page-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'order details', 'order summary', ' purchase details', 'order received details' ),
			),
			'tp-my-account'              => array(
				'label'      => esc_html__( 'My Account', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/my-account-demo/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/add-a-woocommerce-my-account-block-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'my account', 'account dashboard', 'Woo my account', 'woocommerce my account', 'customer profile', 'customer account' ),
			),
			'tp-product-compare'         => array(
				'label'      => esc_html__( 'Product Compare', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/shop-page-demo/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/add-a-woocommerce-product-compare-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'product compare', 'compare products', 'product comparison', 'product compare list' ),
			),
			'tp-product-quick-view'      => array(
				'label'      => esc_html__( 'Product Quick View', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/shop-page-demo/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/add-woocommerce-product-quick-view-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'product quick view', 'quick view modal', 'product quick view modal' ),
			),
			'tp-product-wishlist'        => array(
				'label'      => esc_html__( 'Product Wishlist', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/shop-page-demo/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/add-a-woocommerce-product-wishlist-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'product wishlist', 'wishlist list', 'product wishlist list' ),
			),
			'tp-mini-cart'               => array(
				'label'      => esc_html__( 'Mini Cart', 'the-plus-addons-for-block-editor' ),
				'demoUrl'    => 'https://gtemplates.wdesignkit.com/nexterdemos/shop-page-demo/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'docUrl'     => 'https://nexterwp.com/docs/add-a-woocommerce-mini-cart-in-wordpress/?utm_source=wpbackend&utm_medium=blocks&utm_campaign=nextersettings',
				'videoUrl'   => '',
				'tag'        => 'pro',
				'block_cate' => esc_html__( 'WooCommerce', 'the-plus-addons-for-block-editor' ),
				'keyword'    => array( 'mini cart', 'cart icon', 'cart button', 'cart modal' ),
			),
		);
	...
	public function nxt_wdk_widget_ajax_callback() { // phpcs:ignore Squiz.Commenting.FunctionComment
		...
		if ( ! class_exists( 'nxt_Wdk_Widget_Api' ) ) {
			require_once TPGB_PATH . 'classes/extras/tpgb-wdk-widgets-api.php'; // Adjust this path/constant to match where this file actually lives in your plugin.
		}
	...
	public function tpgb_get_blocks_settings_data() {
		...
		if ( $is_pro ) {
			...
			$setting_data[] = array(
				...
				'name' => esc_html__( 'Enable WooCommerce Swatches', 'the-plus-addons-for-block-editor' ),
				'desc' => esc_html__( 'If you need WooCommerce Swatches from Nexter Blocks, you can enable them to add swatches to your WooCommerce products.', 'the-plus-addons-for-block-editor' ),
			);
		}
