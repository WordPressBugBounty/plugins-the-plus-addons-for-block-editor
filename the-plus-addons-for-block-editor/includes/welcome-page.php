	...
	echo '<div class="tpgb-panel-row">';
		echo '<div class="tpgb-panel-col tpgb-panel-col-35">';
			...
			echo '<div class="tpgb-panel-sec tpgb-welcome-sys-req tpgb-p-20 tpgb-mt-8">';
				...
				echo '<div class="sys-req-label"><span>'.esc_html__('PHP Version : ','tpgb').esc_html( phpversion() ).esc_html__(' Check','tpgb').'</span>'.$php_check_req.'</div>';
		...
		echo '<div class="tpgb-panel-col tpgb-panel-col-65">';
			...
			echo '<div class="tpgb-panel-sec tpgb-p-20 tpgb-welcome-changelog tpgb-mb-8">';
				...
				echo '<div class="tpgb-changelog-list">';
					echo '<div class="changelog-date">'.esc_html__('08 August 2024','tpgb').' <span class="changelog-version">'.esc_html__('3.3.3','tpgb').'</span></div>';
					echo '<ul class="changelog-list">';
						echo '<li>'.esc_html__('Improvement : Optimised for performance : Container block','tpgb').'</li>';
						echo '<li>'.esc_html__('Improvement : Optimised for performance : Container Inner block','tpgb').'</li>';
						echo '<li>'.esc_html__('Improvement : Optimised for performance : Image block','tpgb').'</li>';
						echo '<li>'.esc_html__('Improvement : Optimised for performance : Button block','tpgb').'</li>';
						echo '<li>'.esc_html__('Improvement : Optimised for performance : Paragraph block','tpgb').'</li>';
						echo '<li>'.esc_html__('Improvement : Optimised for performance : Icon Box block','tpgb').'</li>';
						echo '<li>'.esc_html__('Improvement : Optimised for performance : Social Icons block','tpgb').'</li>';
						echo '<li>'.esc_html__('Compatibility : Container block : Wide and Full Width in FSE themes','tpgb').'</li>';
						echo '<li>'.esc_html__('Fixed : Search Bar: Search error message Bug','tpgb').'</li>';
						echo '<li>'.esc_html__('Fixed : Video : Fancybox Bug','tpgb').'</li>';
						echo '<li>'.esc_html__('Fixed : Tab Tours : ARIA Control Bug','tpgb').'</li>';
						echo '<li>'.esc_html__('Fixed : Accordion : ARIA Control Bug','tpgb').'</li>';
						echo '<li>'.esc_html__('Fixed : Code Highlighter : JS Bug','tpgb').'</li>';
						echo '<li>'.esc_html__('Fixed : Data Table : Undefined Variable Bug','tpgb').'</li>';
						echo '<li>'.esc_html__('Fixed : External Form Styler : Dynamic Selector CSS Bug','tpgb').'</li>';
						echo '<li>'.esc_html__('Fixed : Post Comment : Block Editor Compatibility CSS','tpgb').'</li>';
						echo '<li>'.esc_html__('Fixed : FSE Theme : Home Page Bug Fix and Performance Cache inclusion','tpgb').'</li>';
						echo '<li>'.esc_html__('Fixed : Range Component : Bug','tpgb').'</li>';
						echo '<li>'.esc_html__('Fixed : Bugs and Improvements','tpgb').'</li>';
					echo '</ul>';
				echo '</div>';

				echo '<div class="tpgb-changelog-list">';
					echo '<div class="changelog-date">'.esc_html__('20 June 2024','tpgb').' <span class="changelog-version">'.esc_html__('3.3.2','tpgb').'</span></div>';
					echo '<ul class="changelog-list">';
						echo '<li>'.esc_html__('Fixed : Attributes Options : Convert Field Type String to Number.','tpgb').'</li>';
						echo '<li>'.esc_html__('Fixed : Enqueue Style : Double Slash URL bug Fixed.','tpgb').'</li>';
						echo '<li>'.esc_html__('Fixed : Post Title : Count Limit Word/Character Option Bug Fixed','tpgb').'</li>';
						echo '<li>'.esc_html__('Fixed : Bugs and Improvements','tpgb').'</li>';
					echo '</ul>';
				echo '</div>';
