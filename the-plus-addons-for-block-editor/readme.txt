...
- Performance : Nexter Blocks Settings : Panel All Pages Improved Performance
...
- Menu : Nexter Blocks Settings : "Reusable Blocks" Rename to "Patterns"
...
- Update : Nexter Blocks Settings : On Boarding Process update text
- Fix : More Improvement and Bug Fix

= 3.0.0 = 17 June 2023
- Added : Progress Tracker : New Block
- Added : Reusable Block : Add Shortcode Support.
- Added : Nexter Blocks Settings : On Boarding Process
...
- Fix : Appearance : Widgets And Customizer : All Nexter Blocks Hidden in Widgets Area and Customizer Area
...
= 1.1.5 = 11 Sep 2021
- Added : Option of "Reusable Block" in Nexter Blocks Settings
...
= 1.1.4 = 08 Sep 2021
- Fix : Option of Dynamic Cache from Nexter Blocks Settings removed
